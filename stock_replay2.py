...
def main():
    ...
    col1.button("Start Replay", on_click=lambda: st.write('<script>if (window.tvWidget) window.tvWidget.chart().executeActionById("chartReplay");</script>', unsafe_allow_html=True))
    col2.button("Stop Replay", on_click=lambda: st.write('<script>if (window.tvWidget) window.tvWidget.chart().executeActionById("chartReplayStop");</script>', unsafe_allow_html=True))
    col3.button("Reset Replay", on_click=lambda: st.write('<script>if (window.tvWidget) window.tvWidget.chart().executeActionById("chartReplayReset");</script>', unsafe_allow_html=True))

    # Drawing tools
    st.subheader("Drawing Tools")
    col1, col2, col3, col4 = st.columns(4)
    col1.button("Line", on_click=lambda: st.write('<script>if (window.tvWidget) window.tvWidget.chart().createDrawingTemplate("LineToolTrendLine");</script>', unsafe_allow_html=True))
    col2.button("Rectangle", on_click=lambda: st.write('<script>if (window.tvWidget) window.tvWidget.chart().createDrawingTemplate("LineToolRectangle");</script>', unsafe_allow_html=True))
    col3.button("Fibonacci", on_click=lambda: st.write('<script>if (window.tvWidget) window.tvWidget.chart().createDrawingTemplate("LineToolFibRetracement");</script>', unsafe_allow_html=True))
    col4.button("Text", on_click=lambda: st.write('<script>if (window.tvWidget) window.tvWidget.chart().createDrawingTemplate("LineToolText");</script>', unsafe_allow_html=True))
