...
def download_corp_action(driver, action_type):
    ...
    purpose = driver.find_element(By.XPATH, '//*[@id="ddlPurpose"]')
    ...
    selected_purpose = driver.find_element(By.XPATH, f'//*[@id="ddlPurpose"]/option[@value=\"{corp_act}\"]')
    ...
    download_csv = driver.find_element(By.XPATH, '//*[@id="lnkDownload"]/i')
